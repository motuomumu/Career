                ...
                <div className={NewsPageCss.kernel} >
                    <Row type="flex" justify="center">
                        ...
                        <Col span={6}>
                            ...
                            <Col span={1}></Col>
                        <Col span={6}>
                            <a href=" http://sh.eastday.com/m/20191228/u1ai20262051.html">
                        <Card
                                style={{ width: 360 } } style={{ height: 450 } }
                                hoverable={true} className={NewsPageCss.content}
                                    >
                        ...
                        <Col span={1}></Col>
                        <Col span={6}>
                        <a href="https://baijiahao.baidu.com/s?id=1653858065714363116&wfr=spider&for=pc">
                            <Card
                    ...
                    <Row type="flex" justify="center">
                            ...
                            <Col span={1}></Col>
                        <Col span={6}>
                            <a href="https://baijiahao.baidu.com/s?id=1654032035751678184&wfr=spider&for=pc ">
                            <Card
                                style={{ width:360}} style={{ height:450}}
                                hoverable={true} className={NewsPageCss.content}
                                >
